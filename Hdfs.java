...
public final class Hdfs {
  ...
  public interface OpenFileRequestOrBuilder extends
     ...
     * </pre>
     *
     * <code>required bool forRead = 2;</code>
     */
    boolean hasForRead();
    /**
     * <pre>
  ...
  public interface OpenFileResponseOrBuilder extends
     ...
     * </pre>
     *
     * <code>required int32 handle = 2;</code>
     */
    boolean hasHandle();
    /**
     * <pre>
  ...
  public interface AssignBlockResponseOrBuilder extends
    ...
    /**
     * <code>required .BlockLocations newBlock = 2;</code>
     */
    boolean hasNewBlock();
    /**
     * <code>required .BlockLocations newBlock = 2;</code>
  ...
  public  static final class FileData extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return Hdfs.internal_static_FileData_descriptor;
    }

    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return Hdfs.internal_static_FileData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Hdfs.FileData.class, Hdfs.FileData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof Hdfs.FileData)) {
        return super.equals(obj);
      }
      Hdfs.FileData other = (Hdfs.FileData) obj;
    ...
    public static Hdfs.FileData parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static Hdfs.FileData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Hdfs.FileData parseFrom(
    ...
    public static Hdfs.FileData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static Hdfs.FileData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static Hdfs.FileData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(Hdfs.FileData prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() {
      return this == DEFAULT_INSTANCE
    ...
    public static final class Builder extends
      ...
      // Construct using Hdfs.FileData.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public Hdfs.FileData getDefaultInstanceForType() {
        return Hdfs.FileData.getDefaultInstance();
      }

      public Hdfs.FileData build() {
        Hdfs.FileData result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public Hdfs.FileData buildPartial() {
        Hdfs.FileData result = new Hdfs.FileData(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Hdfs.FileData) {
          return mergeFrom((Hdfs.FileData)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(Hdfs.FileData other) {
        if (other == Hdfs.FileData.getDefaultInstance()) return this;
        if (other.hasData()) {
          bitField0_ |= 0x00000001;
          data_ = other.data_;
          onChanged();
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Hdfs.FileData parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Hdfs.FileData) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  bitField0_ |= 0x00000001;
    ...
    private static final Hdfs.FileData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new Hdfs.FileData();
    }

    public static Hdfs.FileData getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  public interface BlockReportRequestOrBuilder extends
    ...
    /**
     * <code>required .DataNodeLocation location = 2;</code>
     */
    boolean hasLocation();
    /**
     * <code>required .DataNodeLocation location = 2;</code>
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      " \002(\005\022!\n\010newBlock\030\002 \002(\0132\017.BlockLocations\"" +
      "#\n\020ListFilesRequest\022\017\n\007dirName\030\001 \002(\t\"6\n\021" +
      "ListFilesResponse\022\016\n\006status\030\001 \002(\005\022\021\n\tfil" +
      "eNames\030\002 \003(\t\"\'\n\020ReadBlockRequest\022\023\n\013bloc",
      "kNumber\030\001 \002(\005\"1\n\021ReadBlockResponse\022\016\n\006st" +
      "atus\030\001 \002(\005\022\014\n\004data\030\002 \003(\014\"\030\n\010FileData\022\014\n\004" +
      "data\030\001 \002(\t\"[\n\022BlockReportRequest\022\n\n\002id\030\001" +
      " \002(\005\022#\n\010location\030\002 \002(\0132\021.DataNodeLocatio" +
